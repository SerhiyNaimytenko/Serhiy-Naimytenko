...
void C_Library::setAverage_number_of_uses(int average_number_of_uses)
{
    this->average_number_of_uses = average_number_of_uses;
}
void  C_Library::setYear_Creating(int year_creating)
{
    this->year_creating = year_creating;
}
void  C_Library::setNumber_of_function(int number_of_functions)
{
