...
int Interface()
{
    ...
    while (command != 0)
    {
        ...
        if (command == 404)
            return 1;
        cout << "Введите команду котора соответствует контейнеру" << "1 - vector " << endl << "2 - list " << endl << "3 - set " << endl << "4 - map " << endl << "0 - завершение роботы програмы " << endl;
        cin >> command;
    }
    return 0;
}
...
void  Str_output(stringstream& str)
{
    ...
    if (expansion == "") /**< якщо ім'я данної бібліотеки складається з одного слова то остання змінна залишається пустою */
        cout << "- " << setw(10) << id << setw(13) << number_of_function << setw(21) << year_creating << setw(20) << dynamically << setw(30) << name1 << setw(26) << name2 << setw(24) << name_f << setw(20) << name_l << endl; /**< виведення на екран*/
    else /**< якщо ім'я данної бібліотеки складається з двух слів то відповідність ззмінних та інформації зберігається */
    {
        ...
        cout << "- " << setw(10) << id << setw(13) << number_of_function << setw(21) << year_creating << setw(20) << dynamically << setw(30) << name1 << setw(26) << name_f << setw(24) << name_l << setw(20) << expansion << endl; /**< виведення на екран*/
    }
}