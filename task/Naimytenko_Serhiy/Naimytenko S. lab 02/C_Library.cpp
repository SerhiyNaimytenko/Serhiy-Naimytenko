...
C_Library::C_Library(char* dynamically, const int ID, const int year_creating, const int number_of_functions) : dynamically(dynamically), ID(ID), year_creating(year_creating), number_of_functions(number_of_functions)
{
}
